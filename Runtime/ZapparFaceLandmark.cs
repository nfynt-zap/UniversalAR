...
public class ZapparFaceLandmark : MonoBehaviour, ZapparCamera.ICameraListener
{
    ...
    public void OnZapparInitialised(IntPtr pipeline)
    {
        ...
        InitFaceLandmark();
        m_faceTrackerPtr = faceTracker.FaceTrackingPipeline;
    ...
    void Update()
    {
        ...
        Z.FaceTrackerAnchorUpdateIdentityCoefficients(m_faceTrackerPtr, m_faceTrackerId, ref m_identity);
        Z.FaceTrackerAnchorUpdateExpressionCoefficients(m_faceTrackerPtr, m_faceTrackerId, ref m_expression);
